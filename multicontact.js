...
document.addEventListener("DOMContentLoaded", function() {
    var form = document.getElementById("multicontact-form");
    var message = document.getElementById("multicontact-message");
    var spinner = document.getElementById("multicontact-spinner");
